 ...
 *                                                                             *
 *    08.15.2008     Maddox, Marlo                                             *
 *                   Modified set_attribute_value() routine to use isgraph     *
 *                   to properly terminate strings that had extra space on the *
 *                   end.                                                      *
 *                                                                             *
      ...
      char *database_file)
{
         ...
         database_file_ptr) != NULL)
   {
      ...
      if (strstr(
            current_line,
            open_ggcm_init_time_entry) != NULL)
      {
      ...
      if (strstr(
            current_line,
            batsrus_special_parameter_NX_entry) !=NULL)
      {
      ...
      if (strstr(
            current_line,
            batsrus_special_parameter_NY_entry) !=NULL)
      {
      ...
      if (strstr(
            current_line,
            batsrus_special_parameter_NZ_entry) !=NULL)
      {
      ...
      if (strstr(
            current_line,
            batsrus_special_parameter_P1_entry) !=NULL)
      {
      ...
      if (strstr(
            current_line,
            batsrus_special_parameter_P2_entry) !=NULL)
      {
      ...
      if (strstr(
            current_line,
            batsrus_special_parameter_P3_entry) !=NULL)
      {
      ...
      int verbose_flag)
{
   ...
   printf(
         "length 0f -->%s<-- up to first white space = %d\n",
         temp_buffer,
         string_len);
   ...
   /** now try to explicitly terminate entry_value_array **/

   entry_value_array[string_len] = '\0';

   if ( !isgraph(entry_value_array[string_len-1]) )
   {
      printf(
            "!!!!! WARNING\tentry_value_array[%d] is not properly NULL TERMINATED\n\tstring value = --->%s<---\nadjusting...",
            string_len-1,
            entry_value_array);

      entry_value_array[string_len-1] = '\0';
