        ...
        int write_database_info_flag)
{
    ...
    char *readme_text =
            "ENLIL is a time-dependent 3D MHD model of the heliosphere. It "
                ...
                ").  These two grids are now grid_system_1 -> r,phi,theta & "
                "grid_system_2 -> r1,phi1,theta1.  Variables for the spatial "
                ...
                "following:  evh data is on grid_system_3 -> r2,phi2,theta2 with "
                "variables of the name *_1 ie. rho_1, br_1, bphi_1, btheta_1....."
                ".evl data is on grid_system_4 -> r3,phi3,theta3 with variables "
                "of the name *_2 ie. rho_2, br_2, , bphi_2, btheta_2......evg "
                "data is on grid_system_5 -> r4,phi4,theta4 with variables of the"
                " name *_3 ie. rho_3, br_3, bphi_3, btheta_3......evp data is on "
                "grid_system_5 -> r4,phi4,theta4 with variables of the name *_4 "
                "ie. rho_4, br_4, bphi_4, btheta_4";
    ...
    char *grid_system_1 = "[ r, phi, theta ]";

    /** grid system two for time file x1h,x2h,x3h **/
    char *grid_system_2 = "[ r1, phi1, theta1 ]";

    /** grid system three for evh files **/
    char *grid_system_3 = "[ r2, phi2, theta2 ]";

    /** grid system four for evl files **/
    char *grid_system_4 = "[ r3, phi3, theta3 ]";

    /** grid system five for evg files **/
    char *grid_system_5 = "[ r4, phi4, theta4 ]";

    /** grid system six for evp files **/
    char *grid_system_6 = "[ r5, phi5, theta5 ]";
...
{
stat = update_ccmc_variable_attribute_value( "phi", "variable_size", &tim_n2,
        baselined_ccmc_variable_structure_list );
stat = update_ccmc_variable_value( "phi", tim_n2, tim_x2_position_X2,
        baselined_ccmc_variable_structure_list );
...
{
stat = update_ccmc_variable_attribute_value( "theta", "variable_size", &tim_n3,
        baselined_ccmc_variable_structure_list );
stat = update_ccmc_variable_value( "theta", tim_n3, tim_x3_position_X3,
        baselined_ccmc_variable_structure_list );
...
{
stat = update_ccmc_variable_attribute_value( "phi1", "variable_size", &tim_n2h,
        baselined_ccmc_variable_structure_list );

stat = update_ccmc_variable_value( "phi1", tim_n2h, tim_x2h_position_X2H,
        baselined_ccmc_variable_structure_list );

linear_minmax_search( tim_x2h_position_X2H, tim_n2h, &actual_min, &actual_max );

stat = update_ccmc_variable_attribute_value( "phi1", "actual_min", &actual_min,
        baselined_ccmc_variable_structure_list );

stat = update_ccmc_variable_attribute_value( "phi1", "actual_max", &actual_max,
        baselined_ccmc_variable_structure_list );
...
{
stat = update_ccmc_variable_attribute_value( "theta1", "variable_size",
        &tim_n3h, baselined_ccmc_variable_structure_list );

stat = update_ccmc_variable_value( "theta1", tim_n3h, tim_x3h_position_X3H,
        baselined_ccmc_variable_structure_list );

linear_minmax_search( tim_x3h_position_X3H, tim_n3h, &actual_min, &actual_max );

stat = update_ccmc_variable_attribute_value( "theta1", "actual_min",
        &actual_min, baselined_ccmc_variable_structure_list );

stat = update_ccmc_variable_attribute_value( "theta1", "actual_max",
        &actual_max, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_attribute_value( "uphi", "variable_size",
        &number_of_cells, baselined_ccmc_variable_structure_list );
stat = update_ccmc_variable_value( "uphi", number_of_cells, tim_x2_velocity_V2,
        baselined_ccmc_variable_structure_list );
linear_minmax_search( tim_x2_velocity_V2, number_of_cells, &actual_min,
        &actual_max );
stat = update_ccmc_variable_attribute_value( "uphi", "actual_min", &actual_min,
        baselined_ccmc_variable_structure_list );
stat = update_ccmc_variable_attribute_value( "uphi", "actual_max", &actual_max,
        baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_attribute_value( "utheta", "variable_size",
        &number_of_cells, baselined_ccmc_variable_structure_list );
stat = update_ccmc_variable_value( "utheta", number_of_cells,
...
linear_minmax_search( tim_x3_velocity_V3, number_of_cells, &actual_min,
        &actual_max );
stat = update_ccmc_variable_attribute_value( "utheta", "actual_min",
        &actual_min, baselined_ccmc_variable_structure_list );
stat = update_ccmc_variable_attribute_value( "utheta", "actual_max",
        &actual_max, baselined_ccmc_variable_structure_list );
...
{
stat =
    update_ccmc_variable_attribute_value( "bphi", "variable_size", &number_of_cells, baselined_ccmc_variable_structure_list );
stat = update_ccmc_variable_value( "bphi", number_of_cells, tim_x2_magnetic_field_B2, baselined_ccmc_variable_structure_list );
...
{
stat = update_ccmc_variable_attribute_value( "btheta", "variable_size", &number_of_cells, baselined_ccmc_variable_structure_list );
stat = update_ccmc_variable_value( "btheta", number_of_cells, tim_x3_magnetic_field_B3, baselined_ccmc_variable_structure_list );
...
/************** now create and update b1r, b1phi, and b1theta on the fly using br, bphi, btheta & bp *******************/
...
if( verbose_flag ) { printf("Creating b1phi variable from by and bp with correct polarity to undo anti-reconection feature of advection..."); }
...
stat = update_ccmc_variable_value( "phi2", evh_nhel, evh_x2_position_X2, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "theta2", evh_nhel, evh_x3_position_X3, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "uphi_1", number_of_cells, evh_x2_velocity_V2, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "utheta_1", number_of_cells, evh_x3_velocity_V3, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "bphi_1", number_of_cells, evh_x2_magnetic_field_B2, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "btheta_1", number_of_cells, evh_x3_magnetic_field_B3, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "phi3", number_of_cells, evl_x2_position_X2, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "theta3", number_of_cells, evl_x3_position_X3, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "uphi_2", number_of_cells, evl_x2_velocity_V2, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "utheta_2", number_of_cells, evl_x3_velocity_V3, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "bphi_2", number_of_cells, evl_x2_magnetic_field_B2, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "btheta_2", number_of_cells, evl_x3_magnetic_field_B3, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "phi4", number_of_cells, evg_x2_position_X2, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_value( "theta4", number_of_cells, evg_x3_position_X3, baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_attribute_value( "phi5", "variable_size",
      &number_of_cells, baselined_ccmc_variable_structure_list );
stat = update_ccmc_variable_value( "phi5", number_of_cells, evp_x2_position_X2,
      baselined_ccmc_variable_structure_list );
...
stat = update_ccmc_variable_attribute_value( "theta5", "variable_size",
      &number_of_cells, baselined_ccmc_variable_structure_list );
stat = update_ccmc_variable_value( "theta5", number_of_cells, evp_x3_position_X3,
      baselined_ccmc_variable_structure_list );
