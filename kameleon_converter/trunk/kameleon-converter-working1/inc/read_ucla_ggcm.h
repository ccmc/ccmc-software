...
*                     Changed MAX_GRID_SIZE_X, MAX_GRID_SIZE_Y, MAX_GRID_SIZE_Z*
*                     from 1000x500x500 to 10000x5000x5000                     *
*                                                                              *
*       07.25.2008    Maddox, Marlo                                            *
*                     Added name lenght variables so we can reformat the strings*
*                     before and after fortran calls.                          *
*                                                                              *
*******************************************************************************/
...
float    gridx_bx[MAX_GRID_SIZE_X];    /* bx1, by1, bz1 are on staggered grids seperate from above...thus the following grids are needed*/
...
float resistivity_resis_actual_min, resistivity_resis_actual_max;
...
static int gridx_name_len = 5, gridy_name_len = 5, gridz_name_len = 5; /* so we can reform our strings after fortran mangles them */
static int gridx_bx_name_len = 5, gridy_bx_name_len = 5, gridz_bx_name_len = 5; /* so we can reform our strings after fortran mangles them */
static int gridx_by_name_len = 5, gridy_by_name_len = 5, gridz_by_name_len = 5; /* so we can reform our strings after fortran mangles them */
static int gridx_bz_name_len = 5, gridy_bz_name_len = 5, gridz_bz_name_len = 5; /* so we can reform our strings after fortran mangles them */
...
static int density_rr_name_len = 2, pressure_pp_name_len = 2;
static int velocity_vx_name_len = 2, velocity_vy_name_len = 2, velocity_vz_name_len = 2;
static int magnetic_field_bx_name_len = 2, magnetic_field_by_name_len = 2, magnetic_field_bz_name_len = 2;
...
static int magnetic_field_bx1_name_len = 3, magnetic_field_by1_name_len = 3, magnetic_field_bz1_name_len = 3;
static int current_density_xjx_name_len = 3, current_density_xjy_name_len = 3, current_density_xjz_name_len = 3;

static     char    resistivity_resis_name[80]  = { 'r', 'e', 's', 'i', 's', '\0' };

static int resistivity_resis_name_len = 5;
