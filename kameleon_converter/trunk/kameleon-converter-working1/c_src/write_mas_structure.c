      ...
      int write_database_info_flag)
{
   ...
   char *grid_system_1 = "[ phi, theta, r ]";
   char *grid_system_2 = "[ phi, theta, r1 ]";
   char *grid_system_3 = "[ phi, theta1, r ]";
   char *grid_system_4 = "[ phi, theta1, r1 ]";

   char *output_type = "solar";

   char *standard_grid_target = "[ r, lon, colat ]";

   char *grid_1_type = "spherical phi, theta , r";
   char *grid_2_type = "spherical phi, theta , r1";
   char *grid_3_type = "spherical phi, theta1 , r";
   char *grid_4_type = "spherical phi, theta1 , r1";
   ...
   int theta_plus1_dimension_size = fakedim1_plus1, r_plus1_dimension_size =
         fakedim2_plus1;
   ...
   int grid_system_1_dimension_1_size = phi_dimension_size;
   int grid_system_1_dimension_2_size = theta_dimension_size;
   int grid_system_1_dimension_3_size = r_dimension_size;

   int grid_system_2_dimension_1_size = phi_dimension_size;
   int grid_system_2_dimension_2_size = theta_dimension_size;
   int grid_system_2_dimension_3_size = r_plus1_dimension_size;

   int grid_system_3_dimension_1_size = phi_dimension_size;
   int grid_system_3_dimension_2_size = theta_plus1_dimension_size;
   int grid_system_3_dimension_3_size = r_dimension_size;

   int grid_system_4_dimension_1_size = phi_dimension_size;
   int grid_system_4_dimension_2_size = theta_plus1_dimension_size;
   int grid_system_4_dimension_3_size = r_plus1_dimension_size;

   /** lets just make the number of cells equal to the maximun **/

   number_of_cells1 = phi_dimension_size * theta_plus1_dimension_size
         * r_plus1_dimension_size; /** for variables rho, t, p, u_phi, and j_phi **/
   number_of_cells2 = phi_dimension_size * theta_plus1_dimension_size
         * r_dimension_size; /** vr, jr, b_theta **/
   number_of_cells3 = phi_dimension_size * theta_dimension_size
         * r_plus1_dimension_size; /** br, j_theta, v_theat **/
   number_of_cells4 = phi_dimension_size * theta_dimension_size
