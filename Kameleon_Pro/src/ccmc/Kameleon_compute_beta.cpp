 ...
 * @return
 */
float KameleonInterpolator::compute_beta(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3,
		float& dComponent1, float& dComponent2, float& dComponent3)
{
	...
	if (modelName == "mas")
	{
		bComponent1 = interpolate("br", positionComponent1, positionComponent2, positionComponent3,
		...
		bComponent2 = interpolate("bphi", positionComponent1, positionComponent2, positionComponent3,
				dComponent1, dComponent2, dComponent3);
	...
	{
		bComponent1 = interpolate("bx", positionComponent1, positionComponent2, positionComponent3,
					dComponent1, dComponent2, dComponent3);
		if (bComponent1 == missingValue)
					return missingValue;

		bComponent2 = interpolate("by", positionComponent1, positionComponent2, positionComponent3,
				dComponent1, dComponent2, dComponent3);
		if (bComponent2 == missingValue)
					return missingValue;

		bComponent3 = interpolate("bz", positionComponent1, positionComponent2, positionComponent3,
				dComponent1, dComponent2, dComponent3);
		if (bComponent3 == missingValue)
					return missingValue;
	...
	p = interpolate("p", positionComponent1, positionComponent2, positionComponent3,
				dComponent1, dComponent2, dComponent3);
	if (p == missingValue)
		return missingValue;
...
float KameleonInterpolator::compute_beta(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3)
{
	...
	return compute_beta(variable, positionComponent1, positionComponent2, positionComponent3,
			dComponent1, dComponent2, dComponent3);
}
