 ...
 */
float KameleonInterpolator::compute_polb(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3)
{
	float dComponent1, dComponent2, dComponent3;
	return compute_polb(variable, positionComponent1, positionComponent2, positionComponent3,
...
{
	std::string bp_ = "bp";
	float interp_value = interpolate(bp_,positionComponent1,positionComponent2,positionComponent3,
					dComponent1, dComponent2, dComponent3);
	if (interp_value < 0.0)
	{
        interp_value = 1.0;
