...
namespace ccmc
{
	 ...
	 * @param dComponent3
	 */
	float KameleonInterpolator::interpolate(const std::string& variable, const float& positionComponent1,
			...
			float& dComponent3)
	{
		...
		{
			interp_value = (this->*(calculationMethod[variable]))(variable, positionComponent1, positionComponent2,
			...
			const float& positionComponent2, const float& positionComponent3)
	{
		...
		return interpolate(variable, positionComponent1, positionComponent2, positionComponent3, dComponent1,
