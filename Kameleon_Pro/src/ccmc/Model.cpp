...
{
	boost::unordered_map<std::string, std::vector<float>*>::iterator iter = variableData.find(
			variable);
...
{
	boost::unordered_map<std::string, std::vector<int>*>::iterator iter = variableDataInt.find(
			variable);
...
{
	boost::unordered_map<long, std::vector<float>*>::iterator iter = variableDataByID.find(
			variable_id);
...
{
	boost::unordered_map<long, std::vector<int>*>::iterator iter = variableDataIntByID.find(
			variable_id);
...
{
	boost::unordered_map<std::string, float>::iterator iter = conversionFactorsToSI.find(
				variable);
