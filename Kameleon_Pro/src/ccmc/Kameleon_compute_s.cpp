 ...
 * @return
 */
float KameleonInterpolator::compute_s(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3)
{
	float dComponent1, dComponent2, dComponent3;
	return compute_s(variable,positionComponent1, positionComponent2, positionComponent3,
		...
		float& dComponent1, float& dComponent2, float& dComponent3)
{
	...
	t = interpolate("t", positionComponent1, positionComponent2, positionComponent3,
			 dComponent1, dComponent2, dComponent3);
	if (t == missingValue) return missingValue;
	n = interpolate("n", positionComponent1, positionComponent2, positionComponent3,
			 dComponent1, dComponent2, dComponent3);
