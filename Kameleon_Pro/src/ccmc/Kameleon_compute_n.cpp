 ...
 * @return
 */
float KameleonInterpolator::compute_n(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3,
...
//std::cout << "KameleonInterpolator::compute_n." << std::endl;
	float n = interpolate(rho_, positionComponent1, positionComponent2, positionComponent3,
...
float KameleonInterpolator::compute_n(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3)
{
	...
	return compute_n(variable, positionComponent1, positionComponent2, positionComponent3,
			dComponent1, dComponent2, dComponent3);
}
