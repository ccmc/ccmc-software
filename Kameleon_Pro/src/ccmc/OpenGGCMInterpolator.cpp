 ...
 * @return
 */
float OpenGGCMInterpolator::interpolate(long variable_id, const float& c0, const float& c1, const float& c2)
{
 ...
 * @return
 */
float OpenGGCMInterpolator::interpolate(const std::string& variable, const float& c0, const float& c1, const float& c2)
{
 ...
 */
float OpenGGCMInterpolator::interpolate(const std::string& variable, const float& c0, const float& c1, const float& c2, float& dc0, float& dc1, float& dc2)
{
	//Point<float> point;
 ...
 * @return The interpolated value at position (c0,c1,c2) with deltas (dc0,dc1,dc2)
 */
float OpenGGCMInterpolator::interpolate(long variable_id, const float& c0, const float& c1, const float& c2, float& dc0, float& dc1, float& dc2)
{
	//Point<float> point;
