      program f2c_interp_ctip
 
c     Three functions used to interpolate 
c     data from a specified ctip cdf file
 
      integer f2c_open_cdf, f2c_close_cdf, f2c_interp_ctip_cdf
      external f2c_open_cdf, f2c_close_cdf, f2c_interp_ctip_cdf
...
c     --- call the interpolation routine ---
      ...
      status=
     /f2c_interp_ctip_cdf(x,y,z,interpolated_value, var_to_read )
