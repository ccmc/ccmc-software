...
int main(int argc, char *argv[])
{
    ...
    {
        interp_value1 = interpolate_enlil_cdf(variable, n, Y, Z, 1, 0);
        interp_value2 = interpolate_enlil_cdf_2(variable, n, Y, Z, 1, 0);
        /*printf("%d\t%s [ %f, %f, %f ]\t%g %s\tdelta %f %s\n", count, variable, n, Y, Z, interp_value1, get_units( variable ), delta_x, get_units( "x" ) );*/
        printf("%g\t%g\t%g\t%g\n", n, Y, Z, interp_value1);
        printf("%g\t%g\t%g\t%g\n", n, Y, Z, interp_value2);
        count++;
    }
