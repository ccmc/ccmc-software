...
extern float gattribute_float_get(
      char *);
extern double gattribute_double_get(
      char *);
...
extern float interpolate_adapt3d_cdf(
      char *,
      float,
      float,
      float,
...
extern float interpolate_mas_cdf(
      char *,
      float,
      float,
      float,
...
extern "C"
{
   ...
   double gattribute_double_get( char * );
   char * get_units(char * );
   void close_cdf( void );
   ...
   float interpolate_adapt3d_cdf( char *, float, float, float, int, int, ... );
