 ...
 * @return
 */
float KameleonInterpolator::compute_p(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3,
		float& dComponent1, float& dComponent2, float& dComponent3)
{
	...
	{
		p = interpolateSimple(p_, positionComponent1, positionComponent2, positionComponent3,
				 dComponent1, dComponent2, dComponent3);
	} else
	{
    	float n = interpolate(n_, positionComponent1, positionComponent2, positionComponent3,
				 dComponent1, dComponent2, dComponent3);
    	float t = interpolate("T", positionComponent1, positionComponent2, positionComponent3,
				 dComponent1, dComponent2, dComponent3);
    	p = n * t;
...
float KameleonInterpolator::compute_p(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3)
{
	...
	return compute_p(variable, positionComponent1, positionComponent2, positionComponent3,
			dComponent1, dComponent2, dComponent3);
}
