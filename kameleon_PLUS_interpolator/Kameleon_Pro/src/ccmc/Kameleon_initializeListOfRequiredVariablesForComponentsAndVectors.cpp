...
*/
    ...
    listOfRequiredVariablesForComponents["edotj"] = createVectorFromList(9, jx_,jy_,jz_,bx_,by_,bz_,ux_,uy_,uz_);
    ...
    listOfRequiredVariablesForComponents["jparr"] = createVectorFromList(6, "jr","jphi","jtheta","br","bphi","btheta");
    listOfRequiredVariablesForComponents["jparphi"] = createVectorFromList(6, "jr","jphi","jtheta","br","bphi","btheta");
    listOfRequiredVariablesForComponents["jpartheta"] = createVectorFromList(6, "jr","jphi","jtheta","br","bphi","btheta");
	...
	if (modelName == "mas")
	{
    	...
    	listOfRequiredVariablesForComponents["exb"] = createVectorFromList(6, "br","bphi","btheta","ur","uphi","utheta");
    	listOfRequiredVariablesForComponents["exbr"] = createVectorFromList(6, "br","bphi","btheta","ur","uphi","utheta");
    	listOfRequiredVariablesForComponents["exbtheta"] = createVectorFromList(6, "br","bphi","btheta","ur","uphi","utheta");
    	listOfRequiredVariablesForComponents["exbphi"] = createVectorFromList(6, "br","bphi","btheta","ur","uphi","utheta");
    	listOfRequiredVariablesForComponents["edotj"] = createVectorFromList(9, "jr","jphi","jtheta","br","bphi","btheta","ur","uphi","utheta");
    ...
    listOfRequiredVariablesForVectors["edotj"] = createVectorFromList(9, jx_,jy_,jz_,bx_,by_,bz_,ux_,uy_,uz_);
	...
	if ("mas" == modelName)
    {
    	...
    	listOfRequiredVariablesForVectors["exb"] = createVectorFromList(6, "br","bphi","btheta","ur","uphi","utheta");
    	listOfRequiredVariablesForVectors["exbr"] = createVectorFromList(6, "br","bphi","btheta","ur","uphi","utheta");
    	listOfRequiredVariablesForVectors["exbtheta"] = createVectorFromList(6, "br","bphi","btheta","ur","uphi","utheta");
    	listOfRequiredVariablesForVectors["exbphi"] = createVectorFromList(6, "br","bphi","btheta","ur","uphi","utheta");
    	listOfRequiredVariablesForVectors["e"] = createVectorFromList(6, "br", "bphi", "btheta", "ur","uphi","utheta");
    	listOfRequiredVariablesForVectors["er"] = createVectorFromList(6, "br", "bphi", "btheta", "ur","uphi","utheta");
    	listOfRequiredVariablesForVectors["ephi"] = createVectorFromList(6, "br", "bphi", "btheta", "ur","uphi","utheta");
    	listOfRequiredVariablesForVectors["etheta"] = createVectorFromList(6, "br", "bphi", "btheta", "ur","uphi","utheta");
