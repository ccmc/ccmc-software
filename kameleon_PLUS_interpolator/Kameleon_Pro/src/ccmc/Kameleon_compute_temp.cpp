 ...
 * @return
 */
float KameleonInterpolator::compute_temp(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3,
		float& dComponent1, float& dComponent2, float& dComponent3)
{
	...
	{
		float p = interpolate("p", positionComponent1, positionComponent2, positionComponent3,
				 dComponent1, dComponent2, dComponent3);
		if (p == missingValue) return missingValue;
		float rho = interpolate("rho", positionComponent1, positionComponent2, positionComponent3,
						 dComponent1, dComponent2, dComponent3);
		if (rho == missingValue) return missingValue;
		interp_value = p/rho;
	}
    return interp_value;
...
float KameleonInterpolator::compute_temp(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3)
{
	...
	return compute_temp(variable, positionComponent1, positionComponent2, positionComponent3,
			dComponent1, dComponent2, dComponent3);
}
