 ...
 * @return
 */
float KameleonInterpolator::compute_etajComponent1(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3,
		float& dComponent1, float& dComponent2, float& dComponent3)
{
	float eta, jx;
	eta = interpolate("eta", positionComponent1, positionComponent2, positionComponent3,
			dComponent1, dComponent2, dComponent3);
	if (eta == missingValue)
		return missingValue;

	jx = interpolate(jx_, positionComponent1, positionComponent2, positionComponent3,
			 dComponent1, dComponent2, dComponent3);
	if (jx == missingValue)
		return missingValue;
 ...
 * @return
 */
float KameleonInterpolator::compute_etaj(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3)
{
	float dComponent1, dComponent2, dComponent3;
	return compute_etaj(variable, positionComponent1, positionComponent2, positionComponent3,
			dComponent1, dComponent2, dComponent3);
}
		...
		float& dComponent1, float& dComponent2, float& dComponent3)
{
	...
	jy = interpolate(jy_, positionComponent1, positionComponent2, positionComponent3,
			 dComponent1, dComponent2, dComponent3);
	if (jy == missingValue)
		return missingValue;

	jz = interpolate(jz_, positionComponent1, positionComponent2, positionComponent3,
				 dComponent1, dComponent2, dComponent3);
	if (jz == missingValue)
		return missingValue;
 ...
 * @return
 */
float KameleonInterpolator::compute_etajComponent2(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3,
		float& dComponent1, float& dComponent2, float& dComponent3)
{
	float eta, jy;
	eta = interpolate("eta", positionComponent1, positionComponent2, positionComponent3,
 ...
 * @return
 */
float KameleonInterpolator::compute_etajComponent3(const std::string& variable, const float& positionComponent1, const float& positionComponent2, const float& positionComponent3,
		float& dComponent1, float& dComponent2, float& dComponent3)
{
	float eta, jz;
	eta = interpolate("eta", positionComponent1, positionComponent2, positionComponent3,
