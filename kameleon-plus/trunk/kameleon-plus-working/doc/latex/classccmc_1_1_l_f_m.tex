...
The \hyperlink{classccmc_1_1_l_f_m}{L\-F\-M} class gives access to \hyperlink{classccmc_1_1_l_f_m}{L\-F\-M} model results which have been converted into kameleon-\/compatible cdf or hdf-\/5 format. 
...
Averages requested variable for a face, holding face\-\_\-index constant (holding i,j,or k constant) 
...
creates a new \hyperlink{classccmc_1_1_l_f_m}{L\-F\-M} interpolator by storing positions in a kd-\/tree 

Note\-: the kd-\/tree generation can take some time, so re-\/use the resulting interpolator whenever possible

\begin{DoxyReturn}{Returns}
an \hyperlink{classccmc_1_1_l_f_m_interpolator}{L\-F\-M\-Interpolator} object 
\end{DoxyReturn}
...
assumes requested variable is already loaded \hypertarget{classccmc_1_1_l_f_m_ae4a27c5fc9f52300575eb495beaeda9c}{\index{ccmc\-::\-L\-F\-M@{ccmc\-::\-L\-F\-M}!get\-Resolution@{get\-Resolution}}
...
\hyperlink{classccmc_1_1_l_f_m}{L\-F\-M} stores edge components of electric field (ei,ej,ek), which are converted into cell-\/centered vectors. Note\-: these results might be off by a negative sign\-: check that E = -\/v x B 
